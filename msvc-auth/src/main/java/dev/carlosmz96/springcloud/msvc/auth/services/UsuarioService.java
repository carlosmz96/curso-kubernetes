package dev.carlosmz96.springcloud.msvc.auth.services;
...
import dev.carlosmz96.springcloud.msvc.auth.models.Usuario;
...
public class UsuarioService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        try {
            ...
            String error = "Error en el login, no existe el usuario con email " + email + " en el sistema.";
            log.error(error);
